...
public class MinIOUtils {
     ...
     * @return url
     */
    public static String getPresignedPutUrl(String bucketName, String objectName, Integer expires) throws Exception {
     ...
     * @param objectName 文件名称
     * @return 文件信息的字符串表示
     * @throws Exception 如果文件不存在或发生其他错误
     */
     ...
     * @param bucketName 存储桶
     * @param objectName 文件名称
     * @return StatObjectResponse 对象，包含文件的元数据信息
     * @throws Exception 如果文件不存在或发生其他错误
     */
    public static StatObjectResponse getObjectMetadata(String bucketName, String objectName) throws Exception {
        return minioClient.statObject(
                StatObjectArgs.builder()
                        .bucket(bucketName)
                        .object(objectName)
     ...
     * @throws Exception 如果文件不存在或发生其他错误
     */
    public static long getObjectSize(String bucketName, String objectName) throws Exception {
        StatObjectResponse stat = getObjectMetadata(bucketName, objectName);
        return stat.size();
    }
     ...
     * @throws Exception 如果文件不存在或发生其他错误
     */
    public static java.time.ZonedDateTime getObjectLastModified(String bucketName, String objectName) throws Exception {
        StatObjectResponse stat = getObjectMetadata(bucketName, objectName);
     ...
     * @throws Exception 如果文件不存在或发生其他错误
     */
    public static String getObjectETag(String bucketName, String objectName) throws Exception {
        StatObjectResponse stat = getObjectMetadata(bucketName, objectName);
        return stat.etag();
    }
     ...
     * @throws Exception 如果文件不存在或发生其他错误
     */
    public static String getObjectContentType(String bucketName, String objectName) throws Exception {
        StatObjectResponse stat = getObjectMetadata(bucketName, objectName);
     ...
     * @return
     */
    public static void removeFiles(String bucketName, List<String> keys) throws Exception {
    ...
    public static String getPresignedObjectUrl(String bucketName, String objectName, Integer expires) throws Exception {
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder().method(Method.GET).expiry(expires).bucket(bucketName).object(objectName).build();
     ...
     * 获取带有自定义文件名的文件外链
     * @param bucketName 存储桶
     * @param objectName 对象名（MinIO中的文件名，通常是哈希值）
     * @param fileName 原始文件名（下载时显示的文件名）
     * @param expires 过期时间（秒）
     * @return 预签名URL
     * @throws Exception
     */
    public static String getPresignedObjectUrlWithFileName(String bucketName, String objectName, String fileName, Integer expires) throws Exception {
        // 对文件名进行URL编码
